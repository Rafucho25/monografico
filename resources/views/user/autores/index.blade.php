                    ...
                    @foreach ($autores as $autor)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('manage.autores.edit', $autor->id)}}" class="btn btn-primary">Modificar</a>
                                <button class="btn btn-danger eliminar" data-bs-toggle="modal" data-bs-target="#deleteModal" id="{{$autor->id}}">Eliminar</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
